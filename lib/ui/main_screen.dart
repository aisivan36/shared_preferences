...
class _MainScreenState extends State<MainScreen> {
  ...
  void saveCurrentIndex() async {
    /// Use the await keyword to wait for an instance of the
    /// shared preference plugin
    final prefs = await SharedPreferences.getInstance();

    /// Save the selected index as integer
  ...
  void getCurrentIndex() async {
    ...
    /// Check if the preference for our current index already exist
  ...
  void initState() {
    ...
    /// This will retrieve the currently selected index when the page is loaded
    /// finally we need to call [saveCurrentIndex()] when the user taps a tab
    getCurrentIndex();
  }
